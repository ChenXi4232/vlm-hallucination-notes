...
<div class="atlas-grid">
  <a class="atlas-card" href="methods/"><span class="index">38 NOTES</span><h3>论文方法目录</h3><p>按检测、归因、干预与训练层级连接全部已精读论文，不重复正文。</p></a>
...
| 检查项 | 当前结果 | 维护方式 |
|---|---:|---|
| 已登记 Deep Paper Notes | 38 | 由论文 front matter 生成总索引 |
| 有官方图或明确“无方法图”说明，并登记实验 | 38 / 38 | `validate_paper_notes.py` 强制检查元数据、图块与文件 |
| 本轮“待整理”方法论文 | 0 / 4 | 已全部迁移为 Deep Paper Note |
| 仍待判断或待澄清的工作 | 5 | 保留在[待读队列](reading-queue.md)，不混入方法目录 |
