...
<div class="atlas-grid">
  <a class="atlas-card" href="methods/"><span class="index">37 NOTES</span><h3>论文方法目录</h3><p>按检测、归因、干预与训练层级连接全部已精读论文，不重复正文。</p></a>
...
| 检查项 | 当前结果 | 维护方式 |
|---|---:|---|
| 已登记 Deep Paper Notes | 37 | 由论文 front matter 生成总索引 |
| 有官方图或明确“无方法图”说明，并登记实验 | 37 / 37 | `validate_paper_notes.py` 强制检查元数据、图块与文件 |
