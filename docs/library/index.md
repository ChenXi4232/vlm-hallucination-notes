...
<div class="atlas-grid">
  <a class="atlas-card" href="methods/"><span class="index">20 NOTES</span><h3>方法论文目录</h3><p>按干预层级连接全部已精读论文，不重复正文。</p></a>
...
| 检查项 | 当前结果 | 维护方式 |
|---|---:|---|
| 已登记 Deep Paper Notes | 20 | 由论文 front matter 生成总索引 |
| 有对应官方方法图/官方方法页裁图 | 20 / 20 | `validate_paper_notes.py` 强制检查元数据、图块与文件 |
